<header>
	<div class="logo-place"><a href="index.php"><img src="assets/Logotipo.png"></a></div>
	<div class="search-place">
		<input type="text" id="idbusqueda" placeholder="¿Qué estas buscando?" value="<?php if(isset($_GET['text'])){echo $_GET['text'];}else{echo '';} ?>">
...
<script type="text/javascript">
	function mostrar_opciones(){
		if (document.getElementById("ctrl-menu").style.display=="none") {
			/*document.getElementById("ctrl-menu").classList.toggle("show-menu");{*/
...
<div class="menu-opciones" id="ctrl-menu" style="display: none;">	
	...
	<ul>
		...
		<li>
			<a href="pedido.php">
				<div class="menu-opcion">Pendientes</div>
			</a>
		</li>
		<li>
			<a href="_logout.php">
