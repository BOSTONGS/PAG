...
<body>
	...
	<div class="main-content">
		...
		<div class="title"><h3>Mis pedidos</h3></div>
			<div class="body-pedidos" id="space-list">
			</div>
			<div class="titles"><h3>Datos de pago</h3></div>
			<div class="p-line"><div>MONTO TOTAL:</div>MXN $&nbsp;<span id="montototal"></span></div>
			<div class="p-line"><div>Banco:</div>Bancomer</div>
			<div class="p-line"><div>N° de Cuenta:</div>000-00000000-000</div>
			<div class="p-line"><div>Representante:</div>Encargado de ventas</div>
			<div class="notes"><p><b>NOTA:</b> Para confirmar la compra debe realizar el deposito por le monto total, y enviar el comprobante al siguiente correo egames@gmail.com o al número de whatsapp 729 128 5943</p></div>
		</div>
	</div>
